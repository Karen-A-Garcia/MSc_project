...
file = f'/home/karengarcia/criteria_testing/Option_1/ERA5_overshoot_option1_2014.nc' 
ds = xr.open_mfdataset(file)

occurence = ds["Option_1"].sum(dim="valid_time")
...
plt.title(f"ERA5 Criteria Testing \n Option 1: Ice over the tropopause (kg/kg > 0)",fontsize=16)

final_plot_path = f"/home/karengarcia/criteria_testing/Figures/ERA5_option1_test.png"
